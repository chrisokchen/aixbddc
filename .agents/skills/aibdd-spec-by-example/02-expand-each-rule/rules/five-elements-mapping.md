...
- 業務化處理: 補上業務序號（訂單 2406KX8Q7M2P9T），禁止用技術 ID（order-001）
...
- `$aggregate` = 訂單 2406KX8Q7M2P9T（Rule 主詞「訂單」+ 業務序號；寫檔為 `"2406KX8Q7M2P9T"`）
...
- `$aggregate` 填 `order-001`：技術 ID 非業務語言；必須改為業務序號（訂單 2406KX8Q7M2P9T）。
